...
export function NavbarWithSearch() {
  ...
  const navList = (
    <ul className=" mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <a href="#" className="flex items-center text-pedram-2">
          دسته بندی
        </a>
      </Typography>
      <Typography
  ...
  return (
    <Navbar className=" bg-pedram-4	 mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
      <div className="container mx-auto flex flex-wrap items-center justify-between text-blue-gray-900">
        <Link href="/">
          <Typography
            href=""
            className="mr-4 cursor-pointer py-1.5 font-medium text-pedram-1"
            variant="h2"
          >
            TETIS
          </Typography>
        ...
        <div className="hidden items-center gap-x-2 lg:flex">
          ...
          <Button size="xd" className="rounded-lg font-bold">
            جستجو
          </Button>
        </div>
        <IconButton
